...
description: "Production deployment using Docker Compose with PostgreSQL, backend, and web dashboard services"
---
...
services:
  ...
  web:
    image: artifact-keeper/web:latest
...
# Build web dashboard
docker build -t artifact-keeper/web:latest -f docker/Dockerfile.web .
```
...
docker pull artifact-keeper/web:latest
```
