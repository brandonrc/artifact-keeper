...
All package formats can be migrated from Artifactory using the built-in migration API. See [Migrate from Artifactory](/docs/migration/from-artifactory/) for details.
...
- [Migration Guide](/docs/migration/from-artifactory/) - Migrate existing artifacts
